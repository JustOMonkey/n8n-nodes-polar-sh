...
export const discountDescription: INodeProperties[] = [
		...
		options: [
			{
				...
				routing: {
					request: { method: 'POST', url: '=/discounts/', ignoreHttpStatusErrors: true },
			...
			},
			{
				...
				routing: {
					request: { method: 'GET', url: '=/discounts/', ignoreHttpStatusErrors: true },
					output: { postReceive: [handlePolarApiError] },
				},
			},
			{
	...
	...scopeNoticesForResource('discount'),
