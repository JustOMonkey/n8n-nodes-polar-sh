...
- **CHANGELOG**: `1.1.0` entry. Under "Breaking-ish", list the Organization Access Token removal (endpoints gone from Polar's API) and the Member migration (Customer ID now required; old Get Many filters removed).
